  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
      <div className="p-4 sm:p-6 border-b border-gray-100 flex justify-between items-center flex-wrap gap-4">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3 bg-gray-100 p-1 rounded-lg">
           <button
             onClick={() => setIsDetailed(false)}
             className={`px-3 py-1 text-xs sm:text-sm rounded-md transition-all ${!isDetailed ? 'bg-white text-indigo-600 shadow-sm font-medium' : 'text-gray-500 hover:text-gray-700'}`}
           >
             简要版
           </button>
           <button
